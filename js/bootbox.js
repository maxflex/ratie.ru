...
window.bootbox = window.bootbox || (function init($, undefined) {
    ...
    each(buttons, function(key, button, index) {
      ...
      if (!button.className) {
        if (total <= 2 && index === total-1) {
          ...
          button.className = "btn-primary dialog br5";
        } else {
          button.className = "btn-default dialog br5";
        }
      }
    });
  ...
  exports.dialog = function(options) {
    ...
    each(buttons, function(key, button) {
      ...
      buttonStr += "<button data-bb-handler='" + key + "' type='button' class='btn btn-big " + button.className + "'>" + button.label + "</button>";
